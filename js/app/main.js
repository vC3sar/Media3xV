...
import { prettyDate, dateRank, monthGroupKey, monthGroupRank, monthGroupLabel } from './core/date-utils.js';
...
if (window.visualViewport) {
  window.visualViewport.addEventListener('resize', disableStickyForIosMobile, { passive: true });
